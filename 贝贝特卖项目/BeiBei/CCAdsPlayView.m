...
-(void)setAnimationDuration:(NSTimeInterval)animationDuration{
    ...
    _animationDuration = animationDuration>0 ?:2;
...
-(void)downLoadImage{
    if (self.dataArray && self.dataArray.count > 0) {
        ...
        [self.dataArray enumerateObjectsUsingBlock:^(NSString *   obj, NSUInteger idx, BOOL *  stop) {
...
- (void)configContentViews
{
    ...
    [_currentArray enumerateObjectsUsingBlock:^(UIImageView *obj, NSUInteger idx, BOOL *stop) {
